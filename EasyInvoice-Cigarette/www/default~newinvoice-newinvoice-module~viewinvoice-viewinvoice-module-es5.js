    ...
    function NKOA(module, __webpack_exports__, __webpack_require__) {
      ...
      var PrintPreviewComponent = /*#__PURE__*/function () {
        ...
        _createClass(PrintPreviewComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {//this.prepareInvoice();
          }
        }, {
          key: "ngAfterViewInit",
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      return _context3.abrupt("return", this.products.filter(function (a) {
          ...
          value: function pairTo() {
            ...
            html2canvas__WEBPACK_IMPORTED_MODULE_6___default()(element, {
              ...
              img.onload = function (e) {
                ...
                ht = ht + 120;
                var finalPrint = result.align('left').image(img, width, ht, 'threshold', 120).cut('partial').encode();
                console.log(finalPrint);

                _this4.printService.connectToBluetoothPrinter(_this4.profile.selectedPrinter).subscribe(function (res) {
                  _this4.printService.printDataToPrinter(finalPrint).then(function () {
                    _this4.printService.disconnectBluetoothPrinter();
              ...
              alert(error); //   this.modalCtrl.dismiss();
            });
          }
        }, {
