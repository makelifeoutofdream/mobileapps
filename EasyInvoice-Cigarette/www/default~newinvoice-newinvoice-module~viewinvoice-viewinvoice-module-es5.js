          ...
          value: function pairTo() {
            ...
            dom_to_image__WEBPACK_IMPORTED_MODULE_10__["toPng"](node).then(function (dataUrl) {
              ...
              img.onload = function (e) {
                ...
                var finalPrint = result.align('left').image(img, width, ht, 'threshold', 180).initialize().encode(); //   this.printService.sendToBluetoothPrinter(this.profile.selectedPrinter,result.encode());
