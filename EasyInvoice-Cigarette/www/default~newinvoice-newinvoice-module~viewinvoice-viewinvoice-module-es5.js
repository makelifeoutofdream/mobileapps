          ...
          value: function pairTo() {
            ...
            dom_to_image__WEBPACK_IMPORTED_MODULE_10__["toPng"](node).then(function (dataUrl) {
              ...
              img.onload = function (e) {
                ...
                var finalPrint = result.codepage('windows-1252').image(img, width, ht, 'threshold', 120).encode(); //   this.printService.sendToBluetoothPrinter(this.profile.selectedPrinter,result.encode());
