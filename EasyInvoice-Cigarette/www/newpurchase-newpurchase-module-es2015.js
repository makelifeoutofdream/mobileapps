...
let NewpurchasePage = class NewpurchasePage {
    ...
    copyInventoryToPItems() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.purchase.purchaseItems = [];
            for (let inv of this.products) {
    ...
    addNewPurchase() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.purchase.purchaseItems = this.purchase.purchaseItems.filter(a => a.orderQuantity != null && a.orderQuantity != undefined && a.orderQuantity > 0);
