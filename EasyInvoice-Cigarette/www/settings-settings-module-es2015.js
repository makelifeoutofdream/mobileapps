...
let SettingsPage = class SettingsPage {
    constructor(navCtrl, print, toastService, dbService, ref, plt, file) {
    ...
    savefile() {
        try {
            ...
            this.dbService.copyData().then(data => {
                ...
                }).catch(err => alert("failed to create " + JSON.stringify(err)));
            });
        }
        catch (err) {
            alert(err);
