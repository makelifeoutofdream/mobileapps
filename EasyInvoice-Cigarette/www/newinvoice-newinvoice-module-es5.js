        ...
        _createClass(NewinvoicePage, [{
          ...
          value: function resetInvoiceForm() {
            ...
            this.dbService.incrementInvoiceNumber().then(function (data) {
              ...
              _this3.invoice.invoiceNumber = _this3.dbService.codeConstant + _this3.dbService.invoiceCodeConstant + data;
            });
            ...
            this.dbService.getAllCustomers().then(function (data) {
              return _this3.customerList = data;
            });
          }
        }, {
            ...
            if (this.invoice.customer != null && this.invoice.customer != undefined && this.invoice.customer.itemList != null && this.invoice.customer.itemList != undefined) {
              ...
              try {
                var _loop = function _loop() {
                  var inv = _step.value;
                  index = _this4.inventoryList.findIndex(function (i) {
                    return i.id == inv.id;
                  });
                  ...
                  if (index != null && index != undefined && index >= 0) {
                    inventory = {
                      ...
                      balanceQuantity: _this4.inventoryList[index].quantity
                    };

                    _this4.products.push(inventory);

                    _this4.productsBackup.push(inventory); //this.invoice.invoiceItems.push(inventory);
          ...
          value: function submitBill() {
            ...
            this.dbService.createOrUpdateInvoice(this.invoice).then(function (data) {
              _this5.dbService.getAllInventories().then(function (stocks) {
                var stockList = stocks;

                var _iterator3 = _createForOfIteratorHelper(_this5.invoice.invoiceItems),
                    _step3;
                ...
                _this5.dbService.saveAllInventories(stockList).then(function (res) {
                  var index = _this5.customerList.findIndex(function (i) {
                    return i.id == _this5.invoice.customer.id;
                  });

                  _this5.invoice.customer.balance = _this5.invoice.balanceAmount;

                  _this5.dbService.UpdateCustomer(_this5.invoice.customer);

                  _this5.tostService.presentToast("Bill submitted successfully"); //this.navCtrl.navigateRoot('invoice');

                });
              });
            })["catch"](function (reason) {
              _this5.tostService.presentToast("Failed to submit bill");
                  ...
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function () {
                        _this6.navCtrl.navigateRoot('invoice');
                      });
                      modal.present();
