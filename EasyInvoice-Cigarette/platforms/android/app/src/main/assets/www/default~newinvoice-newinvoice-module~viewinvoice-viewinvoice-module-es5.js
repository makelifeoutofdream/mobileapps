    ...
    function NKOA(module, __webpack_exports__, __webpack_require__) {
      ...
      var PrintPreviewComponent = /*#__PURE__*/function () {
        ...
        _createClass(PrintPreviewComponent, [{
          ...
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {// this.pairTo();
          }
        }, {
          ...
          value: function pairTo(width) {
            ...
            dom_to_image__WEBPACK_IMPORTED_MODULE_10__["toPng"](node).then(function (dataUrl) {
              ...
              img.onload = function (e) {
                ...
                alert("selected printer :: " + _this2.profile.selectedPrinter);

                _this2.printService.connectToBluetoothPrinter(_this2.profile.selectedPrinter).subscribe(function (res) {
                  _this2.printService.printDataToPrinter(result.encode()).then(function () {
