...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".green-card {\n  background-color: lightgreen;\n  font-weight: bold;\n  color: black;\n  font-size: large;\n  text-align: center;\n  height: 80px;\n}\n\n.red-card {\n  background-color: red;\n  font-weight: bold;\n  color: black;\n  font-size: large;\n  text-align: center;\n  height: 80px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
class LineElement extends Element {
  ...
  interpolate(point, property) {
    ...
    const points = this.points;
    const segments = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aj"])(this, {property, start: value, end: value});
    if (!segments.length) {
      return;
    }
    const result = [];
...
function getBackgroundPoint(options, size, alignment, chart) {
  ...
  const {topLeft, topRight, bottomLeft, bottomRight} = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["as"])(cornerRadius);
...
class Tooltip extends Element {
  ...
  drawBackground(pt, ctx, tooltipSize, options) {
    ...
    const {topLeft, topRight, bottomLeft, bottomRight} = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["as"])(options.cornerRadius);
    ctx.fillStyle = options.backgroundColor;
    ctx.strokeStyle = options.borderColor;
    ctx.lineWidth = options.borderWidth;
    ctx.beginPath();
...
function generateTicks$1(generationOptions, dataRange) {
  ...
  const decimalPlaces = Math.max(
    Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aF"])(spacing),
    Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aF"])(niceMin)
  );
...
function addTick(ticks, time, timestamps) {
  if (!timestamps) {
    ...
    const {lo, hi} = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aI"])(timestamps, time);
