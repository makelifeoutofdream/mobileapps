(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["newinvoice-newinvoice-module"], {
    ...
    /***/
    function rAb(module, exports, __webpack_require__) {
      "use strict";

      var Buffer = __webpack_require__(
      /*! safer-buffer */
      "xZGU").Buffer; // == UTF32-LE/BE codec. ==========================================================
    ...
    /***/
    function QI(module, exports, __webpack_require__) {
      "use strict";
    ...
    /***/
    function HEcb(module, exports, __webpack_require__) {
      ...
      module.exports = {
        ...
        'gbk': {
          ...
          table: function table() {
            return __webpack_require__(
            /*! ./tables/cp936.json */
            "sv2S").concat(__webpack_require__(
        ...
        'big5hkscs': {
          ...
          table: function table() {
            return __webpack_require__(
            /*! ./tables/cp950.json */
            "htfN").concat(__webpack_require__(
    ...
    /***/
    function JwZZ(module, exports, __webpack_require__) {
      "use strict";

      var Buffer = __webpack_require__(
      /*! safer-buffer */
      "xZGU").Buffer; // NOTE: Due to 'stream' module being pretty large (~100Kb, significant in browser environments), 
    ...
    /***/
    function PQ6H(module, exports, __webpack_require__) {
    ...
    /***/
    function a9ph(module, exports, __webpack_require__) {
      "use strict";
    ...
    /***/
    function gLwZ(module, exports, __webpack_require__) {
    ...
    /***/
    function kMlu(module, exports, __webpack_require__) {
      "use strict";
    ...
    /***/
    function lLtp(module, exports, __webpack_require__) {
      ...
      /*! ./internal */
      "01QI"), __webpack_require__(
      /*! ./utf32 */
      "/rAb"), __webpack_require__(
      /*! ./utf16 */
      "pY1j"), __webpack_require__(
      /*! ./utf7 */
      "xkKp"), __webpack_require__(
      /*! ./sbcs-codec */
      "a9ph"), __webpack_require__(
      /*! ./sbcs-data */
      "PQ6H"), __webpack_require__(
      /*! ./sbcs-data-generated */
      "gLwZ"), __webpack_require__(
      /*! ./dbcs-codec */
      "kMlu"), __webpack_require__(
      /*! ./dbcs-data */
      "HEcb")]; // Put all encoding/alias/codec definitions to single object and export it.
    ...
    function pXoo(module, __webpack_exports__, __webpack_require__) {
      ...
      var iconv_lite__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! iconv-lite */
      "rPnE");
      /* harmony import */


      var iconv_lite__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(iconv_lite__WEBPACK_IMPORTED_MODULE_10__);
      /* harmony import */
        ...
        _createClass(NewinvoicePage, [{
              ...
              try {
                var _loop = function _loop() {
                  ...
                  if (index != null && index != undefined && index >= 0) {
                    ...
                    _this3.productsBackup.push(inventory);
                  }
                };
          ...
          value: function calculateInvoiceTotal(item) {
            ...
            if (item != null && item != undefined) {
              var index = this.invoice.invoiceItems.findIndex(function (i) {
                return i.id == item.id;
              });
              if (index != null && index != undefined && index >= 0) this.invoice.invoiceItems[index].displayBalanceQuantity = this.invoice.invoiceItems[index].balanceQuantity - item.quantity;
            }
          }
        }, {
          key: "submitBill",
            ...
            this.dbService.createOrUpdateInvoice(this.invoice).then(function (data) {
              _this4.dbService.getAllInventories().then(function (stocks) {
                ...
                _this4.dbService.saveAllInventories(stockList).then(function (res) {
                  if (_this4.invoice.balanceAmount >= _this4.invoice.amountPaid) {
                    var index = _this4.customerList.findIndex(function (i) {
                      return i.id == _this4.invoice.customer.id;
                    });

                    _this4.invoice.customer.balance = _this4.invoice.balanceAmount - _this4.invoice.amountPaid;
          ...
          value: function generateQRCodeContent() {
            ...
            var data = "Customer : " + this.invoice.customer.name + "  Address : " + this.invoice.customer.city + "," + this.invoice.customer.district + " Date" + datetime + " Invoice No : " + this.invoice.invoiceNumber + " Total " + this.invoice.total;
            return data;
          }
        }, {
          ...
          value: function getFormatedContent() {
            ...
            var qrcode = encoder.initialize().raw([0x1B, 0x21, 0x03]).align('center').qrcode(this.generateQRCodeContent(), 1, 4, 'h').newline().align('center').raw([0x1B, 0x21, 0x20]).line('Thank You!!!').newline().newline().newline(); // result+=billDetails+itemDetails;
          ...
          value: function printBill() {
            ...
            try {
              ...
              var data = esc + '@';
              data += centerAllign;
              data += esc + '!' + '\x25'; // data+=bold_on;

              data += this.profile.companyName;
              data += newLine; //data+=centerAllign;
              //data+=esc + '!' + '\x01';
              ...
              data += newLine;
              data += left_align;
              data += 'VAT # : ' + this.invoice.customer.vatNumber; //data+=right_align+'CR # : '+this.invoice.customer.crNumber;

              data += newLine;
              data += left_align + 'CR # : ' + this.invoice.customer.crNumber;
              data += newLine;
              data += left_align;
              data += this.getDateFormated(this.invoice.invoiceDate); //data+=right_align;
              ...
              data += left_align;
              data += esc + '\x01';
              data += Object(sprintf_js__WEBPACK_IMPORTED_MODULE_9__["sprintf"])('%s %-24.25s %13s %7s %12s ', '#', 'Items', 'Price', 'Qty', 'Amount'); // data+=newLine;
              ...
              var _iterator5 = _createForOfIteratorHelper(this.invoice.invoiceItems),
                  _step5;

              try {
                for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
                  var itm = _step5.value;
                  data += esc + '!' + '\x00'; // data+=counter+'  '+itm.name+'          '+itm.unitPrice+'   '+itm.quantity+'    '+itm.unitPrice*itm.quantity;
                  ...
                  data += newLine; //data+=right_align+itm.nameInArabic;
                  //data+=newLine;
              ...
              data += newLine;
              data += newLine;
              data = "Ajay"; // data=data+'\x1B' + '\x74' + '\x37' +"اسم";
              ...
              var buf = iconv_lite__WEBPACK_IMPORTED_MODULE_10__["encode"]("اسم", 'cp864');
              var result = this.getFormatedContent();
              this.printService.sendToBluetoothPrinter(this.profile.selectedPrinter, result); //let d1=iconv.encode("اسم", 'cp864');
    ...
    /***/
    function pY1j(module, exports, __webpack_require__) {
      "use strict";
    ...
    /***/
    function rPnE(module, exports, __webpack_require__) {
      "use strict";
      ...
      iconv.getCodec = function getCodec(encoding) {
        ...
        /*! ../encodings */
        "lLtp"); // Lazy load all encoding definitions.
      ...
      iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
        ...
        var streams = __webpack_require__(
        /*! ./streams */
        "JwZZ")(stream_module); // Not public API yet, but expose the stream classes.
      ...
      try {
        stream_module = __webpack_require__(
        /*! stream */
        7);
      } catch (e) {}
    ...
    /***/
    function uCqB(module, exports, __webpack_require__) {
      "use strict";
    ...
    /***/
    function xkKp(module, exports, __webpack_require__) {
      "use strict";
