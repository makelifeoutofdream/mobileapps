      ...
      var NewinvoicePage = /*#__PURE__*/function () {
        ...
        _createClass(NewinvoicePage, [{
          ...
          value: function getFormatedContent() {
            ...
            var qrcode = encoder.initialize().raw([0x1B, 0x21, 0x03]).align('center').qrcode(this.generateQRCodeContent(), 1, 4, 'h').newline().align('center').raw([0x1B, 0x21, 0x20]).line('Thank You!!!');
