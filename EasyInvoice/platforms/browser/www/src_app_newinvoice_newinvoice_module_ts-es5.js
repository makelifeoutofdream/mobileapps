(function () {
  ...
  (self["webpackChunkrem"] = self["webpackChunkrem"] || []).push([["src_app_newinvoice_newinvoice_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _validation_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../validation.service */
      62813);
      /* harmony import */


      var sprintf_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! sprintf-js */
      66782);
      /* harmony import */


      var sprintf_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(sprintf_js__WEBPACK_IMPORTED_MODULE_6__);
        ...
        _createClass(NewinvoicePage, [{
            ...
            this.dbService.createOrUpdateInvoice(this.invoice).then(function (data) {
              _this3.dbService.getAllInventories().then(function (stocks) {
                ...
                _this3.dbService.saveAllInventories(stockList).then(function (res) {
                  _this3.tostService.presentToast("Bill submitted successfully"); //this.navCtrl.navigateRoot('invoice');
          ...
          value: function printBill() {
            try {
              ...
              data += left_align;
              data += esc + '\x01';
              data += (0, sprintf_js__WEBPACK_IMPORTED_MODULE_6__.sprintf)('%s %-24.25s %13s %7s %12s ', '#', 'Items', 'Price', 'Qty', 'Amount'); // data+=newLine;
              ...
              try {
                for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                  ...
                  data += (0, sprintf_js__WEBPACK_IMPORTED_MODULE_6__.sprintf)('%d %-20.20s %9.2f %3.0f %11.2f ', counter, itm.name, itm.unitPrice, itm.quantity, itm.unitPrice * itm.quantity);
              ...
              data += newLine;
              data = "اسم";
              this.printService.sendToBluetoothPrinter(this.profile.selectedPrinter, data);
