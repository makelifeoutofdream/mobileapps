...
/* harmony export */   "Papa": function() { return /* binding */ Papa; }
/* harmony export */ });
...
/* harmony import */ var _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic-native/social-sharing/ngx */ 24276);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ 80476);
/* harmony import */ var ngx_papaparse__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-papaparse */ 61704);
/* harmony import */ var _services_toastservice_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/toastservice.service */ 48236);
...
let DataService = class DataService {
    constructor(papa, plt, file, socialSharing, toastService) {
        this.papa = papa;
        this.plt = plt;
        this.file = file;
    ...
    downloadCcSV(invoiceData, filename) {
        ...
        if (this.plt.is('cordova')) {
            this.file.writeFile(this.file.dataDirectory, filename, csvData, { replace: true }).then(res => {
                this.socialSharing.share(null, null, res.nativeURL, null).catch(reason => {
                    this.toastService.presentToast('Failed to share' + reason);
                });
            }).catch(reason => {
