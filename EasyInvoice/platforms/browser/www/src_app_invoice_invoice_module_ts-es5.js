(function () {
  ...
  (self["webpackChunkrem"] = self["webpackChunkrem"] || []).push([["src_app_invoice_invoice_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var papaparse_papaparse_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! papaparse/papaparse.min.js */
      50593);
      /* harmony import */


      var papaparse_papaparse_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(papaparse_papaparse_min_js__WEBPACK_IMPORTED_MODULE_0__);

      var _Papa = /*#__PURE__*/function () {
        function Papa() {
          _classCallCheck(this, Papa);
        ...
        _createClass(Papa, [{
          key: "parse",
          value: function parse(csv, config) {
          ...
          key: "unparse",
          value: function unparse(data, config) {
          ...
          key: "setLocalChunkSize",
          value: function setLocalChunkSize(value) {
          ...
          key: "setRemoteChunkSize",
          value: function setRemoteChunkSize(value) {
          ...
          key: "setDefaultDelimiter",
          value: function setDefaultDelimiter(value) {
      ...
      _Papa.ɵprov = (0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"])({
      ...
      (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](_Papa, [{
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      var _services_toastservice_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./services/toastservice.service */
      48236); //import * as XLSX from 'xlsx';
      //import * as FileSaver from 'file-saver';
      //import {AndroidPermissions} from '@ionic-native/android-permissions/ngx';


      var _DataService = /*#__PURE__*/function () {
        function DataService(papa, plt, file, socialSharing, toastService) {
        ...
        _createClass(DataService, [{
          key: "downloadCcSV",
          value: function downloadCcSV(invoiceData, filename) {
            var _this = this;

            var csvData = this.papa.unparse({
              fields: [' Date,Invoice_Number,Item_Name,Unit_Price,Quantity,Customer,Tax,Total'],
              data: invoiceData
            });

            if (this.plt.is('cordova')) {
              this.file.writeFile(this.file.dataDirectory, filename, csvData, {
                replace: true
              }).then(function (res) {
                _this.socialSharing.share(null, null, res.nativeURL, null)["catch"](function (reason) {
                  _this.toastService.presentToast('Failed to share' + reason);
                });
              })["catch"](function (reason) {
                _this.toastService.presentToast('Failed to download ' + reason);
              });
            } else {
      ...
      _DataService.ctorParameters = function () {
        return [{
          ...
          type: _services_toastservice_service__WEBPACK_IMPORTED_MODULE_2__.ToastserviceService
        }];
      };

      _DataService = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Injectable)({
        providedIn: 'root'
      })], _DataService);
      /***/
    },
        ...
        _createClass(InvoicePage, [{
          ...
          value: function getAllInvoices() {
            ...
            this.dbService.getAllInvoices().then(function (data) {
              ...
              _this2.toastService.presentToast("Failed to fetch invoices");
