...
/* harmony import */ var _validation_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../validation.service */ 62813);
/* harmony import */ var sprintf_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! sprintf-js */ 66782);
/* harmony import */ var sprintf_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(sprintf_js__WEBPACK_IMPORTED_MODULE_6__);
...
let NewinvoicePage = class NewinvoicePage {
    ...
    printBill() {
        try {
            ...
            data += left_align;
            data += esc + '\x01';
            data += (0,sprintf_js__WEBPACK_IMPORTED_MODULE_6__.sprintf)('%s %-24.25s %13s %7s %12s ', '#', 'Items', 'Price', 'Qty', 'Amount');
            // data+=newLine;
